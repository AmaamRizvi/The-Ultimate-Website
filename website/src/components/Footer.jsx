...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-gray-300 p-20 text-black font-founders-grotesk">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] uppercase font-bold leading-none -mb-[1.5vw] tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[6vw] uppercase font-bold leading-none -mb-[1.5vw] tracking-tighter">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className='details font-["Neue_Montreal"] mt-[9vw] px-10'>
          <a
            className="block text-xl font-light mt-2 hover:underline transition duration-500 ease-in-out"
            href="#"
          >
            Instagram
          </a>
